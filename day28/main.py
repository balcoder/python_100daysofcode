...
start_btn = Button(text="Start", command=start_timer, bg="white", bd=0, font=("Arial", 18))
start_btn.grid(column=0, row=2)

reset_btn = Button(text="Reset", command=reset_pomodoro, bg="white", bd=0, font=("Arial", 18))
